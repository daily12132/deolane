...
import Image2 from '../../public/im2.jpg'
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Deolane Bezerra (@dra.deolanebezerra) • Fotos e vídeos do Instagram
        </title>
            ...
            <div className="w-[90%] bg-black p-5 rounded-xl">
              <div className="w-full flex items-center gap-2 mb-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-semibold">dra.deolanebezerra</span>
          ...
          <>
            ...
            <div className="w-full flex flex-col justify-center items-start gap-4 px-4 mt-8">
              <div className="w-full flex items-center justify-between">
                ...
                <div className="flex-1 ml-8">
                  <div className="flex justify-between text-center">
                    <div>
                      <div className="font-bold">292</div>
                      <div className="text-xs">publicações</div>
                    </div>
                    <div>
                      <div className="font-bold">20,9 mi</div>
                      <div className="text-xs">seguidores</div>
                    </div>
                    <div>
                      <div className="font-bold">1.582</div>
              ...
              <div>
                ...
                <p className="text-sm">Deus é bom o tempo todo 🙏🏻</p>
                <p className="text-sm">CEO: @deobeautyoficial</p>
                <p className="text-sm">@zeroum.bet</p>
                <p className="text-sm">Publi: assessoriadeolane@gmail.com</p>
                <p className="text-sm text-[#1977F2]">Ver tradução</p>
                <Link href="/only">
                  https://onlyfans.com/dra.deolanebezerra
                </Link>
